# This repository provides useful code for a variety of different stuff
- [Add scale bar to the image using **Python**](Add_Scale_Bar_to_the_Image/)
- [Measure the aggregation time by processing a video of paired red blood cell aggregation in **Matlab**](Aggregation_time/)
